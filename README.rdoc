...
Add this to your gator project file to use the generators:
    require "gator/as3/useful/generators"

For FlexUnit4 test generators add:
    require "gator/as3/useful/generators/test/flexunit4"

For ASUnit4 test generators add:
    require "gator/as3/useful/generators/test/asunit4"

== Contributing to gator-as3-useful
...
Copyright (c) 2012 Weyert de Boer.
